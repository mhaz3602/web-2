    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-pesanan fa-fw"></i></a>
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="list-pegawai.php">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-pesanan"></i></div>
                            Pesanan
                        </a>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <a href="list-pesanan.php" class="btn btn-secondary"><i class="fas fa-arrpw-left"></i>Back</a>
                            </div>
                            <div class="mt-3">
                                <a href="edit-pesanan.php?id=<?= $pesanan['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i>Edit</a>
                                <a href="delete-pesanan.php?id=<?= $pesanan['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i>Delete</a>
                            </div>
