                        ...
                        <div class="card-body">
                            <form action="edit-pesanan.php?id=<?= $pesanan['id'] ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal" name="tanggal" required value="<?= $pesanan['tanggal'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="diskon" class="form-label">Diskon</label>
                                    <input type="int" class="form-control" id="diskon" name="diskon" required value="<?= $pesanan['diskon'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="status_bayar" class="form-label">Status Bayar</label>
                                    <input type="boolean" class="form-control" id="status_bayar" name="status_bayar" required value="<?= $pesanan['status_bayar'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="anggota_id" class="form-label">Anggota Id</label>
                                    <input type="int" class="form-control" id="anggota_id" name="anggota_id" required value="<?= $pesanan['anggota_id'] ?>">
                                </div>
