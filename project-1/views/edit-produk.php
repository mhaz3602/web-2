                        ...
                        <div class="card-body">
                            <form action="edit-produk.php?id=<?= $produk['id'] ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="VARCHAR" class="form-control" id="nip" name="nip" required value="<?= $produk['nip'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="VARCHAR" class="form-control" id="nama" name="nama" required value="<?= $produk['nama'] ?>">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="DOUBLE" class="form-control" id="harga" name="harga" required value="<?= $produk['harga'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="stok" class="form-label">stok</label>
                                    <input type="INT" class="form-control" id="stok" name="stok" required value="<?= $produk['stok'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="jenis_produk_id" class="form-label">jenis produk id</label>
                                    <input type="INT" class="form-control" id="jenis_produk_id" name="jenis_produk_id" required value="<?= $produk['jenis_produk_id'] ?>">
                                </div>
