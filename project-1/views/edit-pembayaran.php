                        ...
                        <div class="card-body">
                            <form action="edit-pembayaran.php?id=<?= $pembayaran['id'] ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="double" class="form-control" id="jumlah_bayar" name="jumlah_bayar" required value="<?= $pembayaran['jumlah_bayar'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="tanggal" class="form-label">Tanggal</label>
                                    <input type="date" class="form-control" id="tanggal" name="tanggal" required value="<?= $pembayaran['tanggal'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="pesanan_id" class="form-label">pesanan id</label>
                                    <input type="int" class="form-control" id="pesanan_id" name="pesanan_id" required value="<?= $pembayaran['pesanan_id'] ?>">
                                </div>
