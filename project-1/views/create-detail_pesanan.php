            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="create-detail_pesanan.php" method="POST">
                            
                            
                                <div class="mb-3">
                                    <label for="pesanan_id" class="form-label">pesanan id</label>
                                    <input type="int" class="form-control" id="pesanan_id" name="pegawai_id" required>
                                </div>
                                <div class="mb-3">
                                    <label for="produk_id" class="form-produk_id">produk id</label>
                                    <input type="int" class="form-control" id="produk_id" name="produk_id" required>
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah" class="form-produk_id">jumlah</label>
                                    <input type="int" class="form-control" id="jumlah" name="jumlah" required>
                                </div>

                                <a href="list-detail,pesanan.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i>Back</a>
