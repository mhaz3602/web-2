            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="edit-kartu_diskon.php?id=<?= $kartu_diskon['id'] ?>" method="POST">
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required value="<?= $kartu_diskon['nama'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" required value="<?= $kartu_diskon['deskripsi'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="persen_diskon" class="form-label">Persen Diskon</label>
                                    <input type="text" class="form-control" id="persen_diskon" name="persen_diskon" required value="<?= $kartu_diskon['persen_diskon'] ?>">
                                </div>
