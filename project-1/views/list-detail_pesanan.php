                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-end">
                                <a href="create-detail_pesanan.php" class="btn btn-success">
                                    <i class="fas fa-plus"></i>Tambah detail pesanan
                                </a>
                            </div>
                                ...
                                <tbody>
                                    <?php foreach ($detail_pesanan as $index => $item): ?>
                                        <tr>
                                            ...
                                            <td><?= $item['jumlah'] ?></td>
                                            <td>
                                                <a href="detail-detail_pesanan.php?id=<?= $item['id'] ?>" class="btn btn-primary">
                                                    <i class="fas fa-eye"></i>Detail
                                                </a>

                                                <a href="edit-detail_pesanan.php?id=<?= $item['id'] ?>" class="btn btn-warning">
                                                    <i class="fas fa-edit"></i>Edit
                                                </a>

                                                <a href="delete-detail_pesanan.php?id=<?= $item['id'] ?>" class="btn btn-danger">
