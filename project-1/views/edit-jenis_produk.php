            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="list-jenis_produk.php">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="edit-jenis_produk.php?id=<?= $jenis_produk['id'] ?>" method="POST">
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required value="<?= $jenis_produk['nama'] ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsi" class="form-label">deskripsi</label>
                                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" required value="<?= $jenis_produk['deskripsi'] ?>">
                                </div>
                                
                                <a href="list-jenis_produk.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i>Back</a>
