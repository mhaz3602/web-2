            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-anggota.php">produk</a></li>
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="VARCHAR" class="form-control" id="kode" name="kode" required>
                                </div>
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="VARCHAR" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="double" class="form-control" id="harga" name="harga" required>
                                </div>
                                <div class="mb-3">
                                    <label for="jenis_produk_id" class="form-label">jenis produk id</label>
                                    <input type="int" class="form-control" id="jenis_produk_id" name="jenis_produk_id" required>
                                </div>
                                <div class="mb-3">
